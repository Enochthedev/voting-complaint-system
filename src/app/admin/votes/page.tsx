...
export default function AdminVotesPage() {
  ...
  if (editingVote) {
    return (
      <div className="container mx-auto max-w-4xl py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-foreground">Edit Vote</h1>
          <p className="mt-2 text-muted-foreground">Update the voting poll details</p>
        </div>
  ...
  return (
    <div className="container mx-auto max-w-6xl py-8">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Manage Votes</h1>
          <p className="mt-2 text-muted-foreground">Create and manage voting polls for students</p>
        </div>
                  ...
                  <Card key={vote.id} className="p-6">
                    ...
                    <div className="mb-4 rounded-lg border border-border bg-muted p-4">
                      <div className="mb-3 flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => toggleExpandVote(vote.id)}>
