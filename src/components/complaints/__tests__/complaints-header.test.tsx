...
describe('ComplaintsHeader', () => {
  ...
  describe('Student View', () => {
    it('should render "My Complaints" title for students', () => {
      render(<ComplaintsHeader userRole="student" onNewComplaint={mockOnNewComplaint} />);

      expect(screen.getByText('My Complaints')).toBeInTheDocument();
      expect(screen.getByText('View and manage your submitted complaints')).toBeInTheDocument();
    });
  ...
  describe('Lecturer View', () => {
    it('should render "All Complaints" title for lecturers', () => {
      render(<ComplaintsHeader userRole="lecturer" onNewComplaint={mockOnNewComplaint} />);

      expect(screen.getByText('All Complaints')).toBeInTheDocument();
      expect(screen.getByText('View and manage all student complaints')).toBeInTheDocument();
    });
  ...
  describe('Admin View', () => {
    it('should render "All Complaints" title for admins', () => {
      render(<ComplaintsHeader userRole="admin" onNewComplaint={mockOnNewComplaint} />);
