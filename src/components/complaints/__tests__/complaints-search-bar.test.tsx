...
describe('ComplaintsSearchBar', () => {
  ...
  it('should display search error when present', () => {
    render(
      <ComplaintsSearchBar {...defaultProps} searchError="Failed to connect to search service" />
    );

    expect(screen.getByText(/error:/i)).toBeInTheDocument();
    expect(screen.getByText(/failed to connect to search service/i)).toBeInTheDocument();
  });
  ...
  describe('Loading State', () => {
    it('should show loading state when isSearching is true', () => {
      render(<ComplaintsSearchBar {...defaultProps} isSearching={true} searchQuery="test" />);
  ...
  describe('Suggestions', () => {
    it('should display search suggestions when available', () => {
      ...
      render(
        <ComplaintsSearchBar {...defaultProps} searchQuery="br" searchSuggestions={suggestions} />
      );
