        ...
        <div className="mb-6">
            ...
            {useSearch && searchResults && (
                <div className={cn(
                    ...
                    {searchResults.total === 0 ? (
                        <span>
                            <strong>No results found</strong> for "{searchQuery}". Try different keywords or clear your search.
                        </span>
                    ) : (
                        <span>
                            Found <strong>{searchResults.total}</strong> result{searchResults.total !== 1 ? 's' : ''} for "{searchQuery}"
                        </span>
                    )}
                </div>
            )}
